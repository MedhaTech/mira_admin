...
<html>
	<head>
		...
		<title>Mira Chatbot</title>	

		<meta name="keywords" content="WebSite Template" />
		<meta name="description" content="Mira Chatbot">
		<meta name="author" content="okler.net">

		<!-- Favicon -->
		<link rel="shortcut icon" href="img/miira.png" type="image/x-icon" />
		<link rel="apple-touch-icon" href="img/miira.png">
							...
							<div class="header-column">
								<div class="header-row">
									<div class="header-logo">
										<a href="index.php">
											<img alt="Porto" width="172" height="70" src="img/MIRA.png">
										</a>
									</div>
								</div>
							</div>
										...
										<div class="header-nav-main header-nav-main-font-lg header-nav-main-font-lg-upper-2 header-nav-main-mobile-dark header-nav-main-square header-nav-main-dropdown-no-borders header-nav-main-effect-2 header-nav-main-sub-effect-1">
											<nav class="collapse">
												<ul class="nav nav-pills" id="mainNav">
                                                    ...
                                                    <li>
														<a class="nav-link" data-hash data-hash-offset="0" data-hash-offset-lg="68" href="#projects">Chatbot Works</a>
													</li>
													<li>
														<a class="nav-link" data-hash data-hash-offset="0" data-hash-offset-lg="68" href="#services">Features</a>
													</li>
													<li>
													...
													<li>
														<a class="nav-link" data-hash data-hash-offset="0" data-hash-offset-lg="68" href="#team">Testimonials</a>
													</li>
													<li>
