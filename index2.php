...
<div role="main" class="main">
                    ...
                    <div class="d-flex flex-column align-items-center">
                        ...
                        <h2 class="text-color-light font-weight-extra-bold text-12 mb-4 appear-animation"
                            ...
                            <img src="img/slides/slide-blue-line-big.png" class="w-auto appear-animation"
                                 ...
                                 data-plugin-options="{'firstLoadNoAnim': true, 'minWindowWidth': 0}" alt="" />
                        </span> -->
                            </span>
                        </h2>
    ...
    <div id="team" class="container pb-2">
                ...
                <div class="col-lg-auto appear-animation" data-appear-animation="fadeInRightShorter"
                    ...
                    <div class="feature-box feature-box-style-2 d-block d-lg-flex mb-4 mb-lg-0 px-xl-4 mx-lg-5">
                        ...
                        <div class="feature-box-info ps-1">
                            ...
                            <a href="tel:+91-9035 76 1122"
                                class="text-color-light font-weight-semibold text-decoration-none">+91-9035 76 1122</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-auto appear-animation" data-appear-animation="fadeInRightShorter"
